...
module.exports = function (ControllerBaseClass) {
    ...
    return (class TruckController extends ControllerBaseClass {
            ...
            return [
                {
                    ...
                    url: "/api/truck/item/:id",
                    method: "get",
                    isAjax: true
                },
                {
                    action: "actionGetUsersItems",
                    url: "/api/truck/uitems/",
                    method: "get",
                    isAjax: true
                },
                {
                ...
                },
                {
                    ...
                    url: "/api/truck/edit/:id",
                    method: "post",
                    isAjax: true
                },
                {
                    action: "actionDeleteItems",
                    url: "/api/truck/delete/list",
                    method: "delete",
                    isAjax: true
                },
                {
                    action: "actionDeleteItem",
                    url: "/api/truck/delete/:id",
                    method: "delete",
                    isAjax: true
                },
                {
                    action: "actionUnDeleteItems",
                    url: "/api/truck/undelete/list",
                    method: "delete",
                    isAjax: true
                },
                {
                    action: "actionSearch",
                    url: "/api/truck/search",
                    method: "get",
                    isAjax: true
                }
            ];
        ...
        getAvailableFields() {
            const availableFields = Object.keys(app.models.Truck.schema.paths);
        ...
        actionGetOneItem(req, res) {
            ...
            if (user) {
                ...
                app.models.Truck.findOne({ _id: id, is_deleted: false }, function (err, data) {
        ...
        actionGetUsersItems(req, res) {
            ...
            if (user) {
                ...
                const order = 'id';
                app.models.Truck.find({ uid: id, is_deleted: false }, function (err, data) {
                    res.json({ status: true, data: data, error: err });
        ...
        actionGetItemsByIDs(req, res) {
            ...
            if (user) {
                ...
                const offset = req.query.offset ? req.query.offset * 1 : 0;
                const order = 'id';
                app.models.Truck.find({ _id: { $in: ids }, is_deleted: false }, function (err, data) {
                    res.json({ status: true, data: data, error: err });
        ...
        actionCreateItem(req, res) {
            ...
            if (user) {
                ...
                let item = new app.models.Truck(data);
        ...
        actionEditItem(req, res) {
            ...
            if (user) {
                ...
                app.models.Truck.update({ _id: iid, is_deleted: false, uid: uid }, model, false, function (err, data) {
        ...
        actionDeleteItem(req, res) {
            ...
            if (user) {
                ...
                app.models.Truck.update({ _id: id, is_deleted: false, uid: uid }, { is_deleted: true }, false, function (err, data) {
                    res.json({ status: true, data: data, error: err });
                });
            }
        }
        actionDeleteItems(req, res) {
            ...
            if (user) {
                const uid = user._id;
                const ids = req.body.ids || [];
                app.models.Truck.update({ _id: { $in: ids }, is_deleted: false, uid: uid }, { is_deleted: true }, false, function (err, data) {
                    res.json({ status: true, data: data, error: err });
                });
            }
        }
        actionUnDeleteItems(req, res) {
            ...
            if (user) {
                const uid = user._id;
                const ids = req.body.ids || [];
                app.models.Truck.update({ _id: { $in: ids }, is_deleted: true, uid: uid }, { is_deleted: false }, false, function (err, data) {
                    res.json({ status: true, data: data, error: err });
                });
            }
        }
        actionSearch(req, res) {
            ...
            if (user) {
                ...
                app.models.Truck.find(query, function (err, data) {
                    res.json({ status: true, data: data, error: err });
